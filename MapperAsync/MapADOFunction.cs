...
namespace MapperAsync
{
    class MapADOFunction
    {
        public string MakeInsert(string table, DataTable columns)
        {
            ...
            var tempInsert = "";
            var parameter = "";
            var dictionary = "            Dictionary<string, object> param = new Dictionary<string, object>("+columns.Rows.Count+");" + System.Environment.NewLine;
            ...
            insertFunc += "            return await mgrDataSQL.ExecuteNonQuery(sql, param);" + System.Environment.NewLine;
            insertFunc += "        }" + System.Environment.NewLine;
            return insertFunc;
        }
        public string MakeUpdateFunc(string table, DataTable columns)
        {
            ...
            UpdateFunc += System.Environment.NewLine;
            UpdateFunc += "            return await mgrDataSQL.ExecuteNonQuery(sql, param);" + System.Environment.NewLine;
            UpdateFunc += "        }" + System.Environment.NewLine;
            return UpdateFunc;
        }
